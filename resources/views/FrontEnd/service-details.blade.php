                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="form-floating">
                                    ...
                                    @endphp
                                    <input required type="{{ trim($absence_attendance_type_id) != \App\Enums\AppKeysProps::WorkPremission_absence_type_id()->value && trim($absence_attendance_type_id) != \App\Enums\AppKeysProps::PersonnalPremission_absence_type_id()->value  ? 'date' : 'datetime-local' }}" value="{{ $formattedDate }}" class="form-control" name="start_date" id="start_date" placeholder="Subject">
                                ...
                                <br/>
                                <div class="form-floating">
                                    <input required type="{{ trim($absence_attendance_type_id) != \App\Enums\AppKeysProps::WorkPremission_absence_type_id()->value && trim($absence_attendance_type_id) != \App\Enums\AppKeysProps::PersonnalPremission_absence_type_id()->value ? 'date' : 'datetime-local' }}" class="form-control" name="end_date" id="end_date" placeholder="Subject">
                                ...
                                <div class="form-floating">
                                    <select @if($absence_attendance_type_id==\App\Enums\AppKeysProps::AnnuLeave_absence_type_id()->value or $absence_attendance_type_id==\App\Enums\AppKeysProps::Emergency_absence_type_id()->value) required @else @endif name="replacement_employee_number" class="form-control">
