                    ...
                    @foreach($tracking_users as $item)
                        ...
                        @if($item->no_of_approvals=="3")
                           ...
                           <td>{{$item->approval_status}}</td>
                            ...
                            @if($item->no_of_approvals=="3")
                                @if($item->abs_ins_status=="N" and  !str_contains($item->approval_status,'Rejected') and !str_contains($item->top_management_approval_status,'Pending'))
                            ...
                            @if($item->no_of_approvals=="2")
                                @if($item->abs_ins_status=="N" and  !str_contains($item->approval_status,'Rejected') and !str_contains($item->admin_mgr_approval_status,'Pending'))
                                    <td><button  type="button" data-trax="{{$item->transaction_id}}" class="btn btn-primary insert_absence">Insert</button></td>
                                @else
                                    <td></td>
                                @endif
